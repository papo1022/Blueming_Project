                                        ...
                                        <div class="course-grid" id="course-grid">
                                            ...
                                            <c:forEach var="course" items="${courseList}">
                                                ...
                                                <div class="course-card ${themeClass}"
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/course/update?courseId=${course.courseId}"
                                    ...
                                    <div class="right-col">
                                        ...
                                        <%-- 프로필 바 --%>
                                            <div class="profile-bar">
                                                ...
                                                <svg class="profile-bar-avatar" viewBox="0 0 44 44"
                                                        ...
                                                        <c:forEach var="notice" items="${noticeList}">
                                                            <a href="${pageContext.request.contextPath}/notice/detail/${notice.noticeId}"
                                                                ...
                                                                <div class="notice-text">
                                                                    <div class="notice-title">${notice.noticeTitle}
                                                                    </div>
