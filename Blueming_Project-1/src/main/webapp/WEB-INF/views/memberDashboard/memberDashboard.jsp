<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <link rel="stylesheet"
                href="${pageContext.request.contextPath}/resources/css/dashboard/memberDashboard.css">
        </head>
                                    ...
                                    <div class="greeting-row">
                                        ...
                                        <div class="search-bar">
                                            <input type="text" id="search-input" placeholder="검색할 강의를 입력해 주세요."
                                                maxlength="100">
                                            <button type="submit" id="search-btn"><i
                                                                ...
                                                                <%-- 도넛 차트 --%>
                                                                    <div class="donut-wrap">
                                                                        <svg viewBox="0 0 58 58"
                                                                            ...
                                                                            <circle class="donut-bg" cx="29" cy="29"
                                                                                r="22" />
                                                                            <circle class="donut-fill" cx="29" cy="29"
                                                                                r="22"
                                                                                stroke-dasharray="${course.progressRate * 1.382} 138.2"
                                                                                stroke-dashoffset="0" />
                                                                        </svg>
                                                                        <div class="donut-label">${course.progressRate}%
                                                                        </div>
                                                                    </div>
                                                            </div>
                                    ...
                                    <div class="right-col">
                                        ...
                                        <%-- 프로필 카드 --%>
                                            <div class="profile-card">
                                                <svg class="profile-avatar" viewBox="0 0 88 88"
                                                    ...
                                                    <div class="assignment-section">
                                                        ...
                                                        <c:forEach var="assign" items="${assignmentList}">
                                                            <div class="assignment-item">
                                                                ...
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${assign.submitStatus == 'SUBMITTED'}">
                                                                        <a
                                                                            href="${pageContext.request.contextPath}/assignment/list">
                                                                            <button type="button"
                                                                                class="btn-submit">제출</button>
                                                                        </a>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <a
