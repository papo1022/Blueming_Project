...
<body>
    ...
    <div class="update-value"><c:out value="${member.memberId}" /></div>
</div>
...
<div class="update-row">
    ...
    <div class="update-value">
        <input type="text" name="phone" id="phoneInput" value="<c:out value='${member.phone}' />" 
...
<div class="update-row">
    ...
    <div class="update-value">
		<input type="text" name="address" value="<c:out value='${member.address}' />" maxlength="255">
			...
			<div class="update-row">
			    <div class="update-label">권한코드</div>
			    <div class="update-value">
	...
	<script>
		...
		window.onload = function() {
		    // <c:out>을 사용해 문자열 주입을 안전하게 격리합니다.
		    const startNum = "<c:out value='${member.leaveStartDate}' />".trim();
		    const endNum = "<c:out value='${member.leaveEndDate}' />".trim();
