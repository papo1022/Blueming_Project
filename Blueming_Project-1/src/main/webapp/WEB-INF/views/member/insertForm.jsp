    ...
    <div class="container">
        ...
        <form id="enrollForm" action="${pageContext.request.contextPath}/memberlist/insert" method="post">
            ...
            <div class="row">
                ...
                <div class="value"><input type="text" name="loginId" id="loginId" maxlength="20" required>
            ...
            <div class="row">
                ...
                <div class="value"><input type="password" name="loginPwd" id="loginPwd" maxlength="20" required>
			...
			<div class="row">
                ...
                <div class="value"><input type="text" name="name" maxlength="100" required></div>
            </div>
			...
			<div class="row">
                ...
                <div class="value"><input type="text" name="address" maxlength="255" required></div>
			</div>
