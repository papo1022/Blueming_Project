...
<body>
    ...
    <div class="outer">
        <form id="assignmentForm" action="/blueming/assignment/add" method="post" align="center" novalidate>
            ...
            <table class="table">
                ...
                <tr>
                    <td>* 과제명</td>
                    <td>
                        <input type="text" id="assignmentTitle" name="assignmentTitle" maxlength="90">
