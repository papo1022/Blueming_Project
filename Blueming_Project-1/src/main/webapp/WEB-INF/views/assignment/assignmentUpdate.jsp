<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <div class="outer">
            ...
            <form id="content-card" action="/blueming/assignment/update" method="post" align="center" novalidate>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="assignmentTitle" name="assignmentTitle"
                                value="${assignment.assignmentTitle}" maxlength="30">
                    ...
                    <tr>
                        ...
                        <td><textarea id="description" name="description"
                                maxlength="2000">${assignment.description}</textarea></td>
                    </tr>
                    <tr>
                        <td>* 과제 제한 시간</td>
