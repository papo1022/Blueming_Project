<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <body>
            ...
            <div class="outer">
                <form id="content-card" action="updateChapter" align="center" method="post"
                    ...
                    <table class="table">
                        <tr>
                            <td>챕터 번호</td>
                            <td><input type="number" name="chapterOrder" value="${ch.chapterOrder}" required readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>* 챕터명 </td>
                            <td><input type="text" name="chapterTitle" id="chapterTitle" value="${ch.chapterTitle}"
                        ...
                        <tr>
                            <td>동영상 첨부파일</td>
                            <td><input type="file" accept="video/*" name="video"><input type="checkbox"
                                    name="deleteVideo" value="Y">기존 영상 삭제</td>
                        </tr>
                        <tr>
                    ...
                    <div class="buttons" align="center">
                        ...
                        <a href="${pageContext.request.contextPath}/course/chapterDetailView?chapterId=${ch.chapterId}"
